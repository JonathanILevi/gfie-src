Modified by B. Szalkai (2016) to make sure that GFIE source code is properly processed.
Remark: This program, UnitParser is a separate program from GFIE and has its own separate license, listed below.
