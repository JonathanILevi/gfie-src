...
{$ENDIF}
    ...
    function GetWideString(Src: PIfRVariant; var s: Boolean; var typ: string): tbtwidestring;
    function GetUnicodeString(Src: PIfRVariant; var s: Boolean; var typ: string): tbtunicodestring;
    {$ENDIF}
    ...
    function TypeStr(BlockInfo: TPSBlockInfo; p: TPSValue): string;
...
{$ENDIF}
  ...
  RPS_TypeMismatch = 'Type mismatch: %s expected';
  ...
  RPS_InvalidOperation = 'Invalid operation: ''%s''';
  {$IFDEF PS_USESSUPPORT}
...
function GetUInt(Src: PIfRVariant; var s: Boolean; var typ: string): Cardinal;
begin
  case Src.FType.BaseType of
    btU8: Result := Src^.tu8;
    btS8: Result := Src^.ts8;
    ...
    begin
      s := False;
      typ := 'unsigned integer type';
      Result := 0;
    end;
  end;
end;

function GetInt(Src: PIfRVariant; var s: Boolean; var typ: string): Longint;
begin
  case Src.FType.BaseType of
    btU8: Result := Src^.tu8;
    btS8: Result := Src^.ts8;
...
{$IFNDEF PS_NOINT64}
function GetInt64(Src: PIfRVariant; var s: Boolean; var typ: string): Int64;
begin
  case Src.FType.BaseType of
    btU8: Result := Src^.tu8;
    btS8: Result := Src^.ts8;
...
function GetReal(Src: PIfRVariant; var s: Boolean; var typ: string): Extended;
begin
  case Src.FType.BaseType of
    btU8: Result := Src^.tu8;
    btS8: Result := Src^.ts8;
...
function GetString(Src: PIfRVariant; var s: Boolean; var typ: string): tbtString;
begin
  case Src.FType.BaseType of
...
{$IFNDEF PS_NOWIDESTRING}
function TPSPascalCompiler.GetWideString(Src: PIfRVariant; var s: Boolean; var typ: string): tbtwidestring;
begin
  case Src.FType.BaseType of
...
function TPSPascalCompiler.GetUnicodeString(Src: PIfRVariant; var s: Boolean; var typ: string): tbtunicodestring;
begin
  case Src.FType.BaseType of
    ...
    btSingle:
      begin
        if (vartemp.ftype.BaseType = btu8) or (vartemp.ftype.BaseType = btu16) or (vartemp.ftype.BaseType = btu32) then
          var1^.tsingle := GetUInt(vartemp, b, TypeMismatchParam)
        else
          var1^.tsingle := GetInt(vartemp, b, TypeMismatchParam)
      end;
    btDouble:
      begin
        if (vartemp.ftype.BaseType = btu8) or (vartemp.ftype.BaseType = btu16) or (vartemp.ftype.BaseType = btu32) then
          var1^.tdouble := GetUInt(vartemp, b, TypeMismatchParam)
        else
          var1^.tdouble := GetInt(vartemp, b, TypeMismatchParam)
      end;
    btExtended:
      begin
        if (vartemp.ftype.BaseType = btu8) or (vartemp.ftype.BaseType = btu16) or (vartemp.ftype.BaseType = btu32) then
          var1^.textended:= GetUInt(vartemp, b, TypeMismatchParam)
        else
          var1^.textended:= GetInt(vartemp, b, TypeMismatchParam)
      end;
    btCurrency:
      begin
        if (vartemp.ftype.BaseType = btu8) or (vartemp.ftype.BaseType = btu16) or (vartemp.ftype.BaseType = btu32) then
          var1^.tcurrency:= GetUInt(vartemp, b, TypeMismatchParam)
        else
          var1^.tcurrency:= GetInt(vartemp, b, TypeMismatchParam)
      end;
  end;
  ...
  try
    ...
    case Cmd of
      otAdd:
        begin { + }
          case var1.FType.BaseType of
            btU8: var1^.tu8 := var1^.tu8 + GetUint(Var2, Result, TypeMismatchParam);
            btS8: var1^.ts8 := var1^.ts8 + GetInt(Var2, Result, TypeMismatchParam);
            btU16: var1^.tu16 := var1^.tu16 + GetUint(Var2, Result, TypeMismatchParam);
            btS16: var1^.ts16 := var1^.ts16 + GetInt(Var2, Result, TypeMismatchParam);
            btEnum, btU32: var1^.tu32 := var1^.tu32 + GetUint(Var2, Result, TypeMismatchParam);
            btS32: var1^.ts32 := var1^.ts32 + GetInt(Var2, Result, TypeMismatchParam);
            {$IFNDEF PS_NOINT64}btS64: var1^.ts64 := var1^.ts64 + GetInt64(Var2, Result, TypeMismatchParam); {$ENDIF}
            btSingle: var1^.tsingle := var1^.tsingle + GetReal( Var2, Result, TypeMismatchParam);
            btDouble: var1^.tdouble := var1^.tdouble + GetReal( Var2, Result, TypeMismatchParam);
            btExtended: var1^.textended := var1^.textended + GetReal( Var2, Result, TypeMismatchParam);
            btCurrency: var1^.tcurrency := var1^.tcurrency + GetReal( Var2, Result, TypeMismatchParam);
            btSet:
              begin
                ...
                begin
                  TypeMismatchParam := 'same set type';
                  Result := False;
                end;
              end;
            btChar:
              begin
                ConvertToString(Self, FUseUsedTypes, var1, getstring(Var1, b, TypeMismatchParam)+getstring(Var2, b, TypeMismatchParam));
              end;
            btString: tbtstring(var1^.tstring) := tbtstring(var1^.tstring) + GetString(Var2, Result, TypeMismatchParam);
            {$IFNDEF PS_NOWIDESTRING}
            btwideString: tbtwidestring(var1^.twidestring) := tbtwidestring(var1^.twidestring) + GetWideString(Var2, Result, TypeMismatchParam);
            btUnicodeString: tbtunicodestring(var1^.tunistring) := tbtunicodestring(var1^.tunistring) + GetUnicodeString(Var2, Result, TypeMismatchParam);
            btWidechar:
              begin
                ConvertToUnicodeString(Self, FUseUsedTypes, var1, GetUnicodeString(Var1, b, TypeMismatchParam)+GetUnicodeString(Var2, b, TypeMismatchParam));
              end;
            {$ENDIF}
            else
            begin
              TypeMismatchParam := 'number, set, char or string type';
              Result := False;
            end;
          end;
        end;
        ...
        begin { - }
          case Var1.FType.BaseType of
            ...
            btSet:
              ...
              begin
                TypeMismatchParam := 'number or set type';
                Result := False;
              end;
          end;
        end;
      otMul:
        begin { * }
          case Var1.FType.BaseType of
            ...
            btU16: var1^.tu16 := var1^.tu16 * GetUint(Var2, Result, TypeMismatchParam);
            btS16: var1^.ts16 := var1^.ts16 * GetInt(Var2, Result, TypeMismatchParam);
            btU32: var1^.tu32 := var1^.tu32 * GetUint(Var2, Result, TypeMismatchParam);
            btS32: var1^.ts32 := var1^.ts32 * GetInt(Var2, Result, TypeMismatchParam);
            {$IFNDEF PS_NOINT64}btS64: var1^.ts64 := var1^.ts64 * GetInt64(Var2, Result, TypeMismatchParam); {$ENDIF}
            btSingle: var1^.tsingle := var1^.tsingle * GetReal(Var2, Result, TypeMismatchParam);
            btDouble: var1^.tdouble := var1^.tdouble * GetReal(Var2, Result, TypeMismatchParam);
...
{$IFDEF PS_DELPHIDIV}
      ...
      otIntDiv:
        begin { / }
          case Var1.FType.BaseType of
            btU8: var1^.tu8 := var1^.tu8 div GetUint(Var2, Result, TypeMismatchParam);
            btS8: var1^.ts8 := var1^.ts8 div GetInt(Var2, Result, TypeMismatchParam);
            btU16: var1^.tu16 := var1^.tu16 div GetUint(Var2, Result, TypeMismatchParam);
            btS16: var1^.ts16 := var1^.ts16 div GetInt(Var2, Result, TypeMismatchParam);
            btU32: var1^.tu32 := var1^.tu32 div GetUint(Var2, Result, TypeMismatchParam);
            btS32: var1^.ts32 := var1^.ts32 div GetInt(Var2, Result, TypeMismatchParam);
            {$IFNDEF PS_NOINT64}btS64: var1^.ts64 := var1^.ts64 div GetInt64(Var2, Result, TypeMismatchParam); {$ENDIF}
            else Result := False;
          end;
        end;
{$ELSE}
...
{$ENDIF}
      otMod:
        begin { MOD }
          case Var1.FType.BaseType of
            btU8: var1^.tu8 := var1^.tu8 mod GetUint(Var2, Result, TypeMismatchParam);
            btS8: var1^.ts8 := var1^.ts8 mod GetInt(Var2, Result, TypeMismatchParam);
            btU16: var1^.tu16 := var1^.tu16 mod GetUint(Var2, Result, TypeMismatchParam);
            btS16: var1^.ts16 := var1^.ts16 mod GetInt(Var2, Result, TypeMismatchParam);
            btU32: var1^.tu32 := var1^.tu32 mod GetUint(Var2, Result, TypeMismatchParam);
            btS32: var1^.ts32 := var1^.ts32 mod GetInt(Var2, Result, TypeMismatchParam);
            {$IFNDEF PS_NOINT64}btS64: var1^.ts64 := var1^.ts64 mod GetInt64(Var2, Result, TypeMismatchParam); {$ENDIF}
            else
              begin
                TypeMismatchParam := 'integer type';
                Result := False;
              end;
          end;
        end;
      otshl:
        begin { SHL }
          case Var1.FType.BaseType of
            btU8: var1^.tu8 := var1^.tu8 shl GetUint(Var2, Result, TypeMismatchParam);
            btS8: var1^.ts8 := var1^.ts8 shl GetInt(Var2, Result, TypeMismatchParam);
            btU16: var1^.tu16 := var1^.tu16 shl GetUint(Var2, Result, TypeMismatchParam);
            btS16: var1^.ts16 := var1^.ts16 shl GetInt(Var2, Result, TypeMismatchParam);
            btU32: var1^.tu32 := var1^.tu32 shl GetUint(Var2, Result, TypeMismatchParam);
            btS32: var1^.ts32 := var1^.ts32 shl GetInt(Var2, Result, TypeMismatchParam);
            {$IFNDEF PS_NOINT64}btS64: var1^.ts64 := var1^.ts64 shl GetInt64(Var2, Result, TypeMismatchParam); {$ENDIF}
            else
              begin
                TypeMismatchParam := 'integer type';
                Result := False;
      ...
      otshr:
        begin { SHR }
          case Var1.FType.BaseType of
            btU8: var1^.tu8 := var1^.tu8 shr GetUint(Var2, Result, TypeMismatchParam);
            btS8: var1^.ts8 := var1^.ts8 shr GetInt(Var2, Result, TypeMismatchParam);
            btU16: var1^.tu16 := var1^.tu16 shr GetUint(Var2, Result, TypeMismatchParam);
            btS16: var1^.ts16 := var1^.ts16 shr GetInt(Var2, Result, TypeMismatchParam);
            btU32: var1^.tu32 := var1^.tu32 shr GetUint(Var2, Result, TypeMismatchParam);
            btS32: var1^.ts32 := var1^.ts32 shr GetInt(Var2, Result, TypeMismatchParam);
            {$IFNDEF PS_NOINT64}btS64: var1^.ts64 := var1^.ts64 shr GetInt64( Var2, Result, TypeMismatchParam); {$ENDIF}
            else
              begin
                TypeMismatchParam := 'integer type';
                Result := False;
      ...
      otAnd:
        begin { AND }
          case Var1.FType.BaseType of
            btU8: var1^.tu8 := var1^.tu8 and GetUint(Var2, Result, TypeMismatchParam);
            btS8: var1^.ts8 := var1^.ts8 and GetInt(Var2, Result, TypeMismatchParam);
            btU16: var1^.tu16 := var1^.tu16 and GetUint(Var2, Result, TypeMismatchParam);
            btS16: var1^.ts16 := var1^.ts16 and GetInt(Var2, Result, TypeMismatchParam);
            btU32: var1^.tu32 := var1^.tu32 and GetUint(Var2, Result, TypeMismatchParam);
            btS32: var1^.ts32 := var1^.ts32 and GetInt(Var2, Result, TypeMismatchParam);
            btEnum: var1^.ts32 := var1^.ts32 and GetInt(Var2, Result, TypeMismatchParam);
            {$IFNDEF PS_NOINT64}btS64: var1^.ts64 := var1^.ts64 and GetInt64(Var2, Result, TypeMismatchParam); {$ENDIF}
            else
              begin
                TypeMismatchParam := 'integer or enum type';
                Result := False;
              end;
          end;
        end;
      otor:
        begin { OR }
          case Var1.FType.BaseType of
            btU8: var1^.tu8 := var1^.tu8 or GetUint(Var2, Result, TypeMismatchParam);
            btS8: var1^.ts8 := var1^.ts8 or GetInt(Var2, Result, TypeMismatchParam);
            btU16: var1^.tu16 := var1^.tu16 or GetUint(Var2, Result, TypeMismatchParam);
            btS16: var1^.ts16 := var1^.ts16 or GetInt(Var2, Result, TypeMismatchParam);
            btU32: var1^.tu32 := var1^.tu32 or GetUint(Var2, Result, TypeMismatchParam);
            btS32: var1^.ts32 := var1^.ts32 or GetInt(Var2, Result, TypeMismatchParam);
            {$IFNDEF PS_NOINT64}btS64: var1^.ts64 := var1^.ts64 or GetInt64(Var2, Result, TypeMismatchParam); {$ENDIF}
            btEnum: var1^.ts32 := var1^.ts32 or GetInt(Var2, Result, TypeMismatchParam);
            else
              begin
                TypeMismatchParam := 'integer or enum type';
                Result := False;
      ...
      otxor:
        begin { XOR }
          case Var1.FType.BaseType of
            btU8: var1^.tu8 := var1^.tu8 xor GetUint(Var2, Result, TypeMismatchParam);
            btS8: var1^.ts8 := var1^.ts8 xor GetInt(Var2, Result, TypeMismatchParam);
            btU16: var1^.tu16 := var1^.tu16 xor GetUint(Var2, Result, TypeMismatchParam);
            btS16: var1^.ts16 := var1^.ts16 xor GetInt(Var2, Result, TypeMismatchParam);
            btU32: var1^.tu32 := var1^.tu32 xor GetUint(Var2, Result, TypeMismatchParam);
            btS32: var1^.ts32 := var1^.ts32 xor GetInt(Var2, Result, TypeMismatchParam);
            {$IFNDEF PS_NOINT64}btS64: var1^.ts64 := var1^.ts64 xor GetInt64(Var2, Result, TypeMismatchParam); {$ENDIF}
            btEnum: var1^.ts32 := var1^.ts32 xor GetInt(Var2, Result, TypeMismatchParam);
            else
              begin
                TypeMismatchParam := 'integer or enum type';
                Result := False;
      ...
      otGreaterEqual:
        begin { >= }
          case Var1.FType.BaseType of
            btU8: b := var1^.tu8 >= GetUint(Var2, Result, TypeMismatchParam);
            btS8: b := var1^.ts8 >= GetInt(Var2, Result, TypeMismatchParam);
            btU16: b := var1^.tu16 >= GetUint(Var2, Result, TypeMismatchParam);
            btS16: b := var1^.ts16 >= GetInt(Var2, Result, TypeMismatchParam);
            btU32: b := var1^.tu32 >= GetUint(Var2, Result, TypeMismatchParam);
            btS32: b := var1^.ts32 >= GetInt(Var2, Result, TypeMismatchParam);
            {$IFNDEF PS_NOINT64}btS64: b := var1^.ts64 >= GetInt64(Var2, Result, TypeMismatchParam); {$ENDIF}
            btSingle: b := var1^.tsingle >= GetReal( Var2, Result, TypeMismatchParam);
            btDouble: b := var1^.tdouble >= GetReal( Var2, Result, TypeMismatchParam);
            btExtended: b := var1^.textended >= GetReal( Var2, Result, TypeMismatchParam);
            btCurrency: b := var1^.tcurrency >= GetReal( Var2, Result, TypeMismatchParam);
            btSet:
              begin
                if (var1.FType = var2.FType) then
                begin
      ...
      otNotEqual:
        begin { <> }
          case Var1.FType.BaseType of
            ...
            btExtended: b := var1^.textended <> GetReal( Var2, Result, TypeMismatchParam);
            btCurrency: b := var1^.tcurrency <> GetReal( Var2, Result, TypeMismatchParam);
            btEnum: b := var1^.ts32 <> GetInt(Var2, Result, TypeMismatchParam);
            btString: b := tbtstring(var1^.tstring) <> GetString(var2, Result, TypeMismatchParam);
            btChar: b := var1^.tchar <> GetString(var2, Result, TypeMismatchParam);
            {$IFNDEF PS_NOWIDESTRING}
            btWideString: b := tbtWideString(var1^.twidestring) <> GetWideString(var2, Result, TypeMismatchParam);
            btUnicodeString: b := tbtUnicodeString(var1^.tunistring) <> GetUnicodeString(var2, Result, TypeMismatchParam);
            btWideChar: b := var1^.twidechar <> GetUnicodeString(var2, Result, TypeMismatchParam);
            {$ENDIF}
            btSet:
              begin
                if (var1.FType = var2.FType) then
            ...
            begin
              TypeMismatchParam := 'number, enum, string, char or set type';
              Result := False;
            end;
          end;
          ConvertToBoolean(Self, FUseUsedTypes, Var1, b);
      ...
      otEqual:
        begin { = }
          case Var1.FType.BaseType of
            ...
            {$IFNDEF PS_NOWIDESTRING}
            btWideString: b := tbtWideString(var1^.twidestring) = GetWideString(var2, Result, TypeMismatchParam);
            btUnicodeString: b := tbtUnicodeString(var1^.twidestring) = GetUnicodeString(var2, Result, TypeMismatchParam);
            btWideChar: b := var1^.twidechar = GetUnicodeString(var2, Result, TypeMismatchParam);
            {$ENDIF}
            btSet:
              begin
      ...
      otIn:
        begin
          ...
          begin
            Set_membership(GetUint(var1, result, TypeMismatchParam), var2.tstring, b);
          end else
          begin
            TypeMismatchParam := 'container set type';
            Result := False;
          end;
        end;
      else
        begin
          TypeMismatchParam := 'constant';
          Result := False;
        end;
    end;
  except
  ...
  if not Result then
  begin
    with MakeError('', ecTypeMismatch, TypeMismatchParam) do
    begin
      FPosition := Pos;
      FRow := Row;
      FCol := Col;
...
begin
  ...
  begin
    ...
    begin
      MakeError('', ecTypeMismatch, 'enum, char or byte');
      Result := nil;
    end;
    exit;
    ...
    begin
      ...
      case tempf.FType.BaseType of
        ...
        begin
          ...
          MakeError('', ecTypeMismatch, 'integer type');
          Result := nil;
          exit;
        end;
      end;
...
{$IFNDEF PS_NOINTERFACES}
  ...
  begin
    ...
    begin
      MakeError('', ecTypeMismatch, 'interface type');
      Result := nil;
      Exit;
    end;
    FParser.Next;
...
function TPSPascalCompiler.TypeStr(BlockInfo: TPSBlockInfo; p: TPSValue): string;
var
  t: TPSType;
begin
  t := GetTypeNo(BlockInfo, p);
  if t <> nil then
    Result := t.FOriginalName
  else
    Result := 'void';
end;
      ...
      begin
        ...
        begin
          ...
          if (Params[c].ExpectedType = nil) or not (Params[c].ExpectedType.BaseType in [btString,
            ...
            btChar]) then begin
            MakeError('', ecTypeMismatch, 'string type');
            Result := False;
            exit;
          end;
...
{$ENDIF}            
        ...
        begin
          ...
          begin
            MakeError('', ecTypeMismatch, 'corresponding array type');
            Result := False;
            exit;
          end;
        end else if IsVarInCompatible(PType, GetTypeNo(BlockInfo, Params[c].Val)) then
        begin
          MakeError('', ecTypeMismatch, PType.FOriginalName);
          Result := False;
          exit;
        end;
    end;
...
{$ENDIF}
  ...
  begin
    ...
    begin
      with MakeError('', ecTypeMismatch, 'reference type') do
      begin
        FPosition := nilPos;
        FRow := NilRow;
        FCol := nilCol;
  ...
  var
    ...
    begin
      ...
      begin
        ...
        begin
          with MakeError('', ecTypeMismatch, 'corresponding set type') do
          begin
            FCol := arr.item[i].Col;
            FRow := arr.item[i].Row;
        ...
        begin
          c := GetInt(TPSValueData(arr.Item[i]).Data, Result, TypeMismatchParam);
          if not Result then
          begin
            dataval.Free;
            exit;
          ...
          begin
            with MakeError('', ecTypeMismatch, 'byte') do
            begin
              FCol := arr.item[i].Col;
              FRow := arr.item[i].Row;
              FPosition := arr.item[i].Pos;
        ...
        begin
          DataVal.Free;
          MakeError('', ecTypeMismatch, FindBaseType(SetType.BaseType).FOriginalName);
          Result := False;
          exit;
        end;
      end;
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        begin
          MakeError('', ecTypeMismatch, 'procedure or function');
          x.Free;
          x := nil;
          Exit;
        end;
...
{$ENDIF}
              ...
              begin
                ...
                begin
                  ...
                  x := nil;
                  Tmp.Free;
                  MakeError('', ecTypeMismatch, 'char type');
                  exit;
          ...
          begin
            ...
            begin
              ...
              if (u.BaseType = btStaticArray) then
                TPSSubNumber(rr).SubNo := Cardinal(GetInt(TPSValueData(tmp).Data, tmp2, TypeMismatchParam) - TPSStaticArrayType(u).StartOffset)
              else
                TPSSubNumber(rr).SubNo := GetUInt(TPSValueData(tmp).Data, tmp2, TypeMismatchParam);
              tmp.Free;
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          begin
            temp.Free;
            MakeError('', ecTypeMismatch, 'castable class type');
            Result := nil;
            exit;
          end;
        ...
        begin
          temp.Free;
          MakeError('', ecTypeMismatch, 'compatible type');
          Result := nil;
          exit;
        end;
        FParser.Next;
...
{$IFNDEF PS_NOINTERFACES}
            ...
            begin
              temp.Free;
              MakeError('', ecTypeMismatch, 'castable interface type');
              Result := nil;
              exit;
            end;
          end;
...
{$ENDIF}
        ...
        begin
          temp.Free;
          MakeError('', ecTypeMismatch, 'castable type');
          Result := nil;
          exit;
        end;
        FParser.Next;
        ...
        CSTII_Ord:
          begin
            ...
            begin
              NewVar.Free;
              Result := nil;
              MakeError('', ecTypeMismatch, 'char, widechar, enum or integer type');
              exit;
            end;
            NewVarU := TPSUnValueOp.Create;
            NewVarU.SetParserPos(FParser);
          ...
          begin
            ...
            begin
              ...
              begin
                NewVar.Free;
                Result := nil;
                MakeError('', ecTypeMismatch, 'enum or integer type');
                exit;
              end;
              if FParser.CurrTokenID <> CSTI_CloseRound then
              begin
            ...
            begin
              ...
              begin
                NewVar.Free;
                Result := nil;
                MakeError('', ecTypeMismatch, 'reference type');
                exit;
              end;
              if FParser.CurrTokenID <> CSTI_CloseRound then
              begin
    ...
    begin
      ...
      begin
        ...
        if (Op = otAs) and (f2 is TPSValueData) and (TPSValueData(f2).Data.FType.BaseType = btType) then begin
          ...
          if f.aType = nil then
          begin
            MakeError('', ecInvalidOperation, TypeStr(BlockInfo,F1)+' '+OpStr+' '+TypeStr(BlockInfo,F2));
            f.Free;
            Result := nil;
            exit;
          end;
                ...
                case TPSValueData(TPSUnValueOp(p).FVal1).Data^.FType.BaseType of
                  btEnum:
                    begin
                      ...
                      begin
                        MakeError('', ecTypeMismatch, 'boolean');
                        Result := False;
                        exit;
                      end;
                    end;
            ...
            otMinus:
              begin
                case TPSValueData(TPSUnValueOp(p).FVal1).Data^.FType.BaseType of
                  ...
                  begin
                    MakeError('', ecTypeMismatch, 'number');
                    Result := False;
                    exit;
                  end;
                end;
                  ...
                  btU8:
                    begin
                      case TPSValueData(TPSUnValueOp(p).FVal1).Data.Ftype.basetype of
                        ...
                        begin
                          MakeError('', ecTypeMismatch, 'char, widechar or integer type');
                          preplace.Free;
                          Result := False;
                          exit;
                        end;
                  ...
                  btChar:
                    begin
                      case TPSValueData(TPSUnValueOp(p).FVal1).Data.Ftype.basetype of
                        ...
                        begin
                          MakeError('', ecTypeMismatch, 'char or integer type');
                          Result := False;
                          preplace.Free;
                          exit;
                        end;
...
{$IFNDEF PS_NOIDISPATCH}if Val <> nil then CheckIntf(Val, vt, InvalidVal, False);{$ENDIF}
  ...
  begin
    ...
    begin
      MakeError('', ecTypeMismatch, TypeStr(BlockInfo,Outreg));
      Result := False;
      exit;
    end;
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        begin
          with MakeError('', ecTypeMismatch, tmp.ExpectedType.FOriginalName) do
          begin
            pos := tmp.Val.Pos;
            row := tmp.Val.row;
            col := tmp.Val.col;
...
//          BlockWriteByte(BlockInfo, CM_PO); // pop the temp var
  ...
  begin
    ...
    case lType.BaseType of
      ...
      begin
        MakeError('', ecTypeMismatch, 'variant, enum or integer type');
        VariableVar.Free;
        exit;
      end;
    end;
...
begin
  ...
  begin
    ...
    begin
      ...
      begin
        MakeError('', ecTypeMismatch, Att.Fields[i].FieldType.FOriginalName);
        Result := False;
        exit;
      end;
      Inc(i);
        ...
        case OpType of
          ...
          otMinus:
            case p1.FType.BaseType of
              ...
              begin
                MakeError('', ecTypeMismatch, 'number type');
                DisposeVariant(p1);
                Result := nil;
                exit;
              end;
...
begin
  ...
  Parser.Free;
  if result = nil then
    MakeWarning('', ewCustomWarning, '## Could not register type '+Name);
end;
...
begin
  ...
  try
    ...
    begin
      MakeWarning('', ewCustomWarning, '## Could not register method '+Decl);
      Exit;
    end;
...
procedure TPSConstant.SetBool(b: boolean);
begin
  SetInt(integer(b));
end;
...
begin
  case Error of
    ...
    ecTypeMismatch: Result := tbtstring(Format(RPS_TypeMismatch, [Param]));
    ...
    ecInvalidOperation: Result := tbtstring(Format (RPS_InvalidOperation, [Param]));
    {$IFDEF PS_USESSUPPORT}
...
begin
  ...
  FOwner.MakeWarning('', ewCustomWarning, '## Unknown property '+Name);
end;
